...
module.exports = {
  ...
  theme: {
    ...
    colors: {
      ...
      // color palette custom of system
    ...
    animation: {
      ...
      growDown: "growDown 600ms ease-in-out forwards",
      spinningUp: "spinningUp 600ms ease-in-out forwards",
      spinningDown: "spinningDown 150ms ease-in-out forwards",
    },
    ...
    boxShadow: {
      ...
      none: "none",
      bm: "0 3px 10px 0 rgb(204, 204, 204)",
      box: "0 4px 6px 4px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05)",
    },
